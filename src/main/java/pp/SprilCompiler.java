...
public class SprilCompiler implements Compiler {
    ...
    protected File source = new File("input.lang");
    ...
    public static void main(String[] args) {
        int exitCode = new CommandLine(new SprilCompiler()).execute(args);
    ...
    @Override
    public String runFrontend() throws IOException, ParseException {
    ...
    protected String getCmdString(boolean save) {
        if (save) {
    ...
    @Override
    public String runBackend() throws IOException, InterruptedException {
